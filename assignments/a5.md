...
- `service.yml`: This file must be in a specific format and be submitted with no errors. See <https://csc491.dcsil.ca/assignments/a5/> ('Details' of #1, under 'Initial Requirements') for more details on this file.

...
| --- | --- | --- |
| `service.yml` | Is present, error-free, and fully filled out. See Notes Below | 10.0 |
...
| Production / Builds | Application is available from the web, as a mobile application via Microsoft App Center, or a GitHub Release otherwise.<br>Exception tracking via Sentry and Logging is set up. See Notes Below | 25.0 |

...
| --- | --- | --- |
| Use Cases | <ul><li>Describes 3-6 use cases that provide adequate complexity to showcase the teams skills</li><br><li>Use cases are well defined and recorded as a markdown file in the Team Repository</li><br><li>Illustrates UI with low fidelity sketches where applicable</li><br><li>Teaching Staff will approve use cases after submission. Use case approval will not affect grade, but students may be required to re-write some use cases if not approved.</li></ul> | 30.0 |

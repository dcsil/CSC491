...
| [Infrastructure] Test Coverage  | Tests should cover at least 65% of your application and demonstrated in an example CI run. | 15.0 |
...
| [Infrastructure] Operational Excellence  | CI, Exceptions, Logging, and all other services listed in the requirements & `service.yml` example are all setup. Bootstrap script works. | 5.0 |

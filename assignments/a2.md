...
You will be expected to work together and submit this assignment as a team. Anyone can submit it, I suggest using an issue on the team repo you created in A1 to coordinate that submission. The write-up should be written to your team repo, under `team/diversity.md`.
